...
public class Account {
    ...
    public static class AccountManager {
         ...
         * Skulle vi vært litt mer seriøse hadde vi hatt et
         * hashmap eller annet assosiativt map
         */
        ...
        // throws runtime exception if index would cause array out of bounds
        // error
        public static double getBalance(int index) {
            if (index < 0 || index >= size)
                throw new RuntimeException("in getBalance(int index): index out of bounds");
